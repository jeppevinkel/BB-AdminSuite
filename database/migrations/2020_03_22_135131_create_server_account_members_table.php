...
class CreateServerAccountMembersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('server_account_members', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('server_account_members');
    }
}
