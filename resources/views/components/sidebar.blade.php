<div class="bg-gray-900 shadow-lg h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48">
    <div
        ...
        <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->hasPermission($serverAccount->id, 'warn_view'))
                <li class="mr-3 flex-1">
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->hasPermission($serverAccount->id, 'ban_view'))
                <li class="mr-3 flex-1">
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->hasPermission($serverAccount->id, 'member_view'))
                <li class="mr-3 flex-1">
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->hasPermission($serverAccount->id, 'rank_view'))
                <li class="mr-3 flex-1">
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->hasPermission($serverAccount->id, 'player_view'))
                <li class="mr-3 flex-1">
            ...
            @endif
            @if(\Illuminate\Support\Facades\Auth::user()->hasPermission($serverAccount->id, 'settings_view'))
                <li class="mr-3 flex-1">
                    <a href="#"
